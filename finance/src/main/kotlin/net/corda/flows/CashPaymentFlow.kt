...
object CashPaymentFlow {
     ...
     *
     * @param amount the amount of a currency to pay to the otherSide.
     ...
     * @param anonymous whether to anonymous the otherSide party. Should be true for normal usage, but may be false
